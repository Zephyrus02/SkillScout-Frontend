...
| Speaker | `new Audio('/pl_test.wav').play()` (static asset in `/public/pl_test.wav`) |

**Static asset required:** `/public/pl_test.wav` – a short audio test tone.
...
```json
{
  ...
  "metrics": {
    "behavioralVelocity": { "value": "+23%", "label": "High Impact", "progress": 78 },
...
```json
{
  "labels": ["Communication", "Data Struct.", "System Des.", "Behavioral", "Prob. Solving", "Code Quality"],
...
*Last updated: March 2026 – reflects current state of `skillscout-frontend` codebase.*
